var multiClone = (function(){ /*GNU LGPLv3 Copyright (C) 2021 Ed Johnsen*/
	...
	// THIS VERSION CONTAINS SLIGHT, ADDITIONAL ACCELERATION OF FLAT-ARRAY CLONING
	// AT THE COST OF CROSS-FRAME FUNCTIONALITY... 
	// FLAT ARRAYS WILL UTILIZE FUNCTION-SCOPED CONSTRUCTORS.
	...
	function useArrayInstructions(instructions){
		...
		if(instructions.flatArr.length){
			newArr = instructions.flatArr.slice();
			newArr.length = instructions.arrLength;
		}
